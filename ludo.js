...
// }
// rc1.innerHTML = "R";
y=window.scrollY + document.getElementById('red-circle-1').getBoundingClientRect().top-50 // Y
...
// gc1.innerHTML = "G";
y=window.scrollY + document.getElementById('green-circle-1').getBoundingClientRect().top-50 // Y
...
// yc1.innerHTML = "Y";
y=window.scrollY + document.getElementById('yellow-circle-1').getBoundingClientRect().top-50 // Y
...
// bc1.innerHTML = "B";
y=window.scrollY + document.getElementById('blue-circle-1').getBoundingClientRect().top-50 // Y
  ...
  setTimeout(() => {
    ...
    if (previousturn == 1 && redstack[0] != 4 && redstack[0] != 9 && redstack[0] != 17 && redstack[0] != 22 && redstack[0] != 30 && redstack[0] != 35 && redstack[0] != 43 && redstack[0] != 48) {
        ...
        if (redstack[0] == bluestack[0]) {
          ...
          var bluewdana= document.getElementById("bluewdana")
          bluewdana.style.position='absolute';
          bluewdana.style.left=x+"px";
          bluewdana.style.top=y+"px";
          bluestack.push(35)
          blueCounter = 0;
          ifCanMoveBlue = 0
        }
        ...
        if (redstack[0] == greenstack[0]) {
          ...
          var greenwdana= document.getElementById("greenwdana")
          greenwdana.style.position='absolute';
          greenwdana.style.left=x+"px";
          greenwdana.style.top=y+"px";
          greenstack.push(9)
          greenCounter = 0;
          ifCanMoveGreen = 0
        }
      ...
      //green cuts
        ...
        if (redstack[0] == greenstack[0]) {
          ...
          var redwdana= document.getElementById("redwdana")
          redwdana.style.position='absolute';
          redwdana.style.left=x+"px";
          redwdana.style.top=y+"px";
          redstack.push(48)
          redCounter = 0;
          ifCanMoveRed = 0
        }
      ...
      //blue cuts
        ...
        if (bluestack[0] == yellowstack[0]) {
          ...
          reddana
          reddana
          reddanalowdana= document.getElementById("yellowdana")
          yellowdana.style.position='absolute';
          yellowdana.style.left=x+"px";
          yellowdana.style.top=y+"px";
          yellowstack.push(22)
